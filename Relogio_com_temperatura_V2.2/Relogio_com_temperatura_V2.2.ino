...
int calibracao = -2.09; // prototipo
//int calibracao = -7.16; // modelo caixa preta
...
void termometro() { // Leitura do termometro
  ...
  temperaturas[lertemperatura] = (adclido * ((1.1/1023)*100)) + calibracao;
